...
<header>
  ...
  <nav>
    <div class="nav">
      <a class="nav__item <?php if ($currentPage == "yearly-report") echo "nav__item--selected"; ?>" href="/yearly-report">
        <p class="nav__item__text">Jahresreport</p>
      </a>
      <a class="nav__item <?php if ($currentPage == "year-overview") echo "nav__item--selected"; ?>" href="/year-overview">
